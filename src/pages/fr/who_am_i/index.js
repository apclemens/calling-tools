...
const SecondPage = () => (
  ...
  >
    <Seo
      title="Step 2: Sachez qui vous êtes"
...
<div class="languages"></div>
    ...
    <div class="content">
<div><ul><li><Link to="/fr/">Qu'est-ce que l'appel?</Link></li><li><Link to="/fr/personal_well_being">test</Link></li><li>Step 2: Sachez qui vous êtes</li><li><Link to="/fr/personal_agency/">test</Link></li><li><Link to="/fr/references">test</Link></li></ul></div>

<h1 style={{fontWeight: 'bold', fontSize: "4.5rem",textAlign: "center",borderBottom: "2px solid black"}}>Step 2:<br></br>Sachez qui vous êtes</h1>
...
<Link className="back_link" to="/fr/personal_well_being">Back to: test</Link><Link className="next_link" to="/fr/who_am_i/values">Next page: Explorez vos valeurs familiales envers le travail</Link>
    </div>
