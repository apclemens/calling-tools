...
<Link className="back_link" to="/fr/who_am_i/">Back to: Step 2: Sachez qui vous êtes</Link><Link className="next_link" to="/fr/who_am_i/know_your_talents">Next page: Découvrez ce qui est le plus important pour vous</Link>
    </div>
