...
<div class="languages"></div>
    ...
    <div class="content">
<div><ul><li><Link to="/fr/">Qu'est-ce que l'appel?</Link></li><li>test</li><li><Link to="/fr/who_am_i/">Step 2: Sachez qui vous êtes</Link></li><li><Link to="/fr/personal_agency/">test</Link></li><li><Link to="/fr/references">test</Link></li></ul></div>
...
<Link className="back_link" to="/fr/">Back to: Qu'est-ce que l'appel?</Link><Link className="next_link" to="/fr/who_am_i/">Next page: Step 2: Sachez qui vous êtes</Link>
    </div>
