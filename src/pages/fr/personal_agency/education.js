...
<Link className="back_link" to="/fr/personal_agency/research">Back to: test</Link><Link className="next_link" to="/fr/personal_agency/volunteer">Next page: test</Link>
    </div>
