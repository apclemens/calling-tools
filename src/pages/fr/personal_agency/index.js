...
<div class="languages"></div>
    ...
    <div class="content">
<div><ul><li><Link to="/fr/">Qu'est-ce que l'appel?</Link></li><li><Link to="/fr/personal_well_being">test</Link></li><li><Link to="/fr/who_am_i/">Step 2: Sachez qui vous êtes</Link></li><li>test</li><li><Link to="/fr/references">test</Link></li></ul></div>
...
<Link className="back_link" to="/fr/who_am_i/passion_and_interests">Back to: Passions et Intérêts</Link><Link className="next_link" to="/fr/personal_agency/goals">Next page: test</Link>
    </div>
