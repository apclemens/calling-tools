...
<Link className="back_link" to="/fr/personal_agency/online">Retour à: Créez une présence en ligne viable</Link><Link className="next_link" to="/fr/references">Page suivante: Les références</Link>
    </div>
