...
<Link className="back_link" to="/fr/personal_agency/transactions">Back to: test</Link><Link className="next_link" to="/fr/personal_agency/interview">Next page: test</Link>
    </div>
