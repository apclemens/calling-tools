...
<div class="languages"></div>
    ...
    <div class="content">
<div><ul><li><Link to="/pt/">test</Link></li><li><Link to="/pt/personal_well_being">test</Link></li><li><Link to="/pt/who_am_i/">test</Link></li><ul style={{display: 'none'}}><li><Link to="/pt/who_am_i/values">test</Link></li><li><Link to="/pt/who_am_i/know_your_talents">test</Link></li><li><Link to="/pt/who_am_i/passion_and_interests">test</Link></li></ul><li>test</li><ul style={{display: 'none'}}><li><Link to="/pt/personal_agency/goals">test</Link></li><li><Link to="/pt/personal_agency/mentor">test</Link></li><li><Link to="/pt/personal_agency/research">test</Link></li><li><Link to="/pt/personal_agency/education">test</Link></li><li><Link to="/pt/personal_agency/volunteer">test</Link></li><li><Link to="/pt/personal_agency/business">test</Link></li><li><Link to="/pt/personal_agency/parallel">test</Link></li><li><Link to="/pt/personal_agency/transactions">test</Link></li><li><Link to="/pt/personal_agency/online">test</Link></li><li><Link to="/pt/personal_agency/interview">test</Link></li></ul><li><Link to="/pt/references">test</Link></li></ul></div>
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/goals">
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/mentor">
Seek a Mentor
</Link>
</h3>
</li>
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/research">
Do the Research!
</Link>
</h3>
</li>
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/education">
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/volunteer">
Volunteer
</Link>
</h3>
</li>
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/business">
Consider starting your own business or service
</Link>

/

<Link to="/pt/personal_agency/parallel">
Parallel Gigs
</Link>
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/transactions">
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/online">
...
<li aria-level="3">
<h3>
<Link to="/pt/personal_agency/interview">
