...
<Link className="back_link" to="/ht/personal_agency/transactions">Back to: test</Link><Link className="next_link" to="/ht/personal_agency/interview">Next page: test</Link>
    </div>
