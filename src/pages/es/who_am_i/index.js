...
<div class="languages"></div>
    ...
    <div class="content">
<div><ul><li><Link to="/es/">test</Link></li><li><Link to="/es/personal_well_being">test</Link></li><li>test</li><li><Link to="/es/personal_agency/">test</Link></li><li><Link to="/es/references">test</Link></li></ul></div>
...
<Link className="back_link" to="/es/personal_well_being">Back to: test</Link><Link className="next_link" to="/es/who_am_i/values">Next page: test</Link>
    </div>
