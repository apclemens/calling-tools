...
<Link className="back_link" to="/es/">De regreso: ¿Qué es el llamado?</Link><Link className="next_link" to="/es/who_am_i/">Siguiente página: Paso 2: Conoce quién eres</Link>
    </div>
