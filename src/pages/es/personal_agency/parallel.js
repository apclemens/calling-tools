...
<div class="languages"><Link to="/en/personal_agency/parallel">English</Link><Link to="/fr/personal_agency/parallel">Français</Link><Link className="current" to="/es/personal_agency/parallel">Español</Link><Link to="/ht/personal_agency/parallel">Krèyol ayisyen</Link><Link to="/pt/personal_agency/parallel">Português</Link></div>
